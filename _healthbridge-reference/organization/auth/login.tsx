...
export default function OrganizationLoginScreen() {
  ...
  return (
    <AuthShell
      title="Sign in"
      subtitle="Manage your facility workspace on HealthBridge."
      footer={
        <View style={styles.footer}>
          <Text style={styles.footerText}>Register your organization?</Text>
          <Pressable onPress={() => router.push('/auth/organization/register')}>
            <Text style={styles.footerLink}>Create organization account</Text>
          </Pressable>
        </View>
      }
    >
